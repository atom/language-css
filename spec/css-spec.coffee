    ...
    describe 'at-rules', ->
      ...
      describe '@supports', ->
        ...
        it 'embeds rulesets and other at-rules', ->
          ...
          expect(lines[4][19]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.selector.css', 'punctuation.section.function.css']
          ...
          expect(lines[4][22]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.selector.css', 'punctuation.section.function.css']
