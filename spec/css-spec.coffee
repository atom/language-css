describe 'CSS grammar', ->
  ...
  describe 'selectors', ->
    ...
    it 'tokenizes complex selectors', ->
      ...
      expect(tokens[8]).toEqual value: '+', scopes: ["source.css", "meta.selector.css", "keyword.operator.combinator.css"]
      expect(tokens[10]).toEqual value: 'p', scopes: ["source.css", "meta.selector.css", "entity.name.tag.css"]
      ...
      expect(lines[2][19]).toEqual value: ',', scopes: ['source.css', 'meta.selector.css']
      expect(lines[3][0]).toEqual value: 'a', scopes: ['source.css', 'meta.selector.css', 'entity.name.tag.css']
      expect(lines[3][1]).toEqual value: ':', scopes: ['source.css', 'meta.selector.css']
      expect(lines[3][2]).toEqual value: ':', scopes: ['source.css', 'meta.selector.css', 'entity.other.attribute-name.pseudo-class.css', 'punctuation.definition.entity.css']
      ...
      expect(lines[3][4]).toEqual value: ',', scopes: ['source.css', 'meta.selector.css']
      ...
      expect(lines[3][19]).toEqual value: ',', scopes: ['source.css', 'meta.selector.css']
      ...
      expect(lines[4][15]).toEqual value: '{', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.begin.css']
      expect(lines[4][17]).toEqual value: '}', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']
    ...
    describe 'at-rules', ->
      ...
      describe '@media', ->
        it 'tokenises @media keywords correctly', ->
          ...
          expect(tokens[7]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
          ...
          expect(tokens[14]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
        ...
        it 'highlights deprecated media types', ->
          ...
          expect(tokens[8]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        it 'tokenises comments between media types', ->
          ...
          expect(tokens[0]).toEqual value: '@', scopes: ['source.css', 'meta.at-rule.media.css', 'keyword.control.at-rule.media.css', 'punctuation.definition.keyword.css']
          expect(tokens[1]).toEqual value: 'media', scopes: ['source.css', 'meta.at-rule.media.css', 'keyword.control.at-rule.media.css']
          expect(tokens[2]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[4]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[5]).toEqual value: 'only', scopes: ['source.css', 'meta.at-rule.media.css', 'keyword.operator.logical.only.media.css']
          expect(tokens[6]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[8]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[9]).toEqual value: 'screen', scopes: ['source.css', 'meta.at-rule.media.css', 'support.constant.media.css']
          expect(tokens[10]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[12]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(tokens[19]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        it 'tokenises comments between media features', ->
          ...
          expect(tokens[8]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[9]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[10]).toEqual value: '37.5', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css']
          expect(tokens[11]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
          ...
          expect(tokens[13]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[14]).toEqual value: '=', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[15]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[16]).toEqual value: 'and', scopes: ['source.css', 'meta.at-rule.media.css', 'keyword.operator.logical.and.media.css']
          expect(tokens[17]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[18]).toEqual value: '=', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[19]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(tokens[21]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[22]).toEqual value: '=', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[23]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[24]).toEqual value: 'min-height', scopes: ['source.css', 'meta.at-rule.media.css', 'support.type.property-name.media.css']
          expect(tokens[25]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[26]).toEqual value: ':', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[27]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[28]).toEqual value: ':', scopes: ['source.css', 'meta.at-rule.media.css', 'punctuation.separator.key-value.css']
          expect(tokens[29]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[30]).toEqual value: '=', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[31]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(tokens[32]).toEqual value: '1.2', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css']
          expect(tokens[33]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
          expect(tokens[34]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(tokens[35]).toEqual value: ';', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
          expect(tokens[36]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
      ...
      it 'matches media queries across lines', ->
        ...
        expect(lines[0][14]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
        expect(lines[0][15]).toEqual value: ' 40 ', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
        expect(lines[0][16]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
        expect(lines[1][1]).toEqual value: '320', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css']
        expect(lines[1][2]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        expect(lines[1][4]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.media.css', 'punctuation.separator.list.comma.css']
        ...
        expect(lines[2][12]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        expect(lines[2][15]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
        expect(lines[2][16]).toEqual value: ' kek ', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
        expect(lines[2][17]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
        ...
        expect(lines[2][24]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
        expect(lines[2][25]).toEqual value: ':', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
        expect(lines[2][26]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
        ...
        expect(lines[2][32]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.media.css', 'punctuation.separator.list.comma.css']
        ...
        expect(lines[3][11]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
        ...
        expect(lines[3][13]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.media.css', 'punctuation.separator.list.comma.css']
        expect(lines[3][15]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
        expect(lines[3][16]).toEqual value: ' wat ', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
        expect(lines[3][17]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
      ...
      describe '@keyframes', ->
        it 'tokenises keyframe lists correctly', ->
          ...
          expect(lines[1][9]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[2][5]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[3][1]).toEqual value: '50%', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'entity.other.keyframe-offset.percentage.css']
          ...
          expect(lines[3][9]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[3][16]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(lines[3][17]).toEqual value: ' Ignored ', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css']
          expect(lines[3][18]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(lines[4][9]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        it 'matches injected comments', ->
          ...
          expect(lines[0][0]).toEqual value: '@', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'keyword.control.at-rule.keyframes.css', 'punctuation.definition.keyword.css']
          expect(lines[0][1]).toEqual value: 'keyframes', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'keyword.control.at-rule.keyframes.css']
          expect(lines[0][2]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'variable.parameter.keyframe-list.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          ...
          expect(lines[0][4]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'variable.parameter.keyframe-list.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(lines[0][6]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'variable.parameter.keyframe-list.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          ...
          expect(lines[2][0]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'variable.parameter.keyframe-list.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
        ...
        it 'matches offset keywords case-insensitively', ->
          ...
          expect(tokens[12]).toEqual value: 'To', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'entity.other.keyframe-offset.css']
          expect(tokens[14]).toEqual value: '{', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'punctuation.section.property-list.begin.css']
          expect(tokens[15]).toEqual value: '}', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']
          expect(tokens[17]).toEqual value: '}', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'punctuation.section.keyframes.end.css']

        it 'matches percentile offsets', ->
          {tokens} = grammar.tokenizeLine('@keyframes identifier { -50.2% } @keyframes ident2 { .25%}')
          expect(tokens[6]).toEqual value: '-50.2%', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'entity.other.keyframe-offset.percentage.css']
          expect(tokens[16]).toEqual value: '.25%', scopes: ['source.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'entity.other.keyframe-offset.percentage.css']
      ...
      describe '@supports', ->
        it 'tokenises feature queries', ->
          ...
          expect(tokens[8]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
        ...
        it 'embeds rulesets and other at-rules', ->
          ...
          expect(lines[9][5]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[10][5]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[12][1]).toEqual value: '50%', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'entity.other.keyframe-offset.percentage.css']
          ...
          expect(lines[12][9]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[12][16]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(lines[12][17]).toEqual value: ' Ignored ', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css']
          expect(lines[12][18]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(lines[13][9]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.body.css', 'meta.at-rule.keyframes.header.css', 'meta.at-rule.keyframes.body.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        it 'matches feature queries across multiple lines', ->
          ...
          expect(lines[1][10]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[1][13]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(lines[1][15]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
          ...
          expect(lines[1][17]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
          ...
          expect(lines[1][19]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
          ...
          expect(lines[1][21]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.end.bracket.round.css']
          ...
          expect(lines[2][10]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[3][10]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(lines[4][10]).toEqual value: 'px', scopes: ['source.css', 'meta.at-rule.supports.header.css', 'meta.feature-query.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
      ...
      describe 'font-feature declarations', ->
        it 'tokenises font-feature blocks', ->
          ...
          expect(tokens[5]).toEqual value: '{', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.begin.css']
          expect(tokens[7]).toEqual value: '}', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']
      ...
      describe '@counter-style', ->
        it 'tokenises them and their contents correctly', ->
          ...
          expect(lines[2][5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(lines[2][7]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.end.bracket.round.css']
          ...
          expect(lines[2][10]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(lines[2][12]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.end.bracket.round.css']
          ...
          expect(lines[2][15]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(lines[2][17]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.url.css', 'punctuation.section.function.end.bracket.round.css']
        ...
        it 'matches injected comments', ->
          ...
          expect(tokens[2]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.counter-style.css', 'variable.parameter.style-name.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          ...
          expect(tokens[4]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.counter-style.css', 'variable.parameter.style-name.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          expect(tokens[6]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.counter-style.css', 'variable.parameter.style-name.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          ...
          expect(tokens[8]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.counter-style.css', 'variable.parameter.style-name.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
      ...
      describe '@document', ->
        it 'correctly tokenises @document rules', ->
          ...
          expect(lines[0][4]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.url.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(lines[0][6]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.url.css', 'punctuation.section.function.end.bracket.round.css']
          expect(lines[0][7]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.document.css', 'punctuation.separator.list.comma.css']
          expect(lines[1][1]).toEqual value: 'url-prefix', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'support.function.document-rule.css']
          expect(lines[1][2]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.begin.bracket.round.css']
          expect(lines[1][3]).toEqual value: 'http://www.w3.org/Style/', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'variable.parameter.document-rule.css']
          expect(lines[1][4]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.end.bracket.round.css']
          expect(lines[1][5]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.document.css', 'punctuation.separator.list.comma.css']
          expect(lines[1][7]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.document.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(lines[1][8]).toEqual value: ' Comment ', scopes: ['source.css', 'meta.at-rule.document.css', 'comment.block.css']
          expect(lines[1][9]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.document.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(lines[2][1]).toEqual value: 'domain', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'support.function.document-rule.css']
          expect(lines[2][2]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.begin.bracket.round.css']
          expect(lines[2][3]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
          expect(lines[2][4]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          expect(lines[2][5]).toEqual value: 'mozilla.org', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'variable.parameter.document-rule.css']
          expect(lines[2][6]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.end.bracket.round.css']
          expect(lines[2][7]).toEqual value: ',', scopes: ['source.css', 'meta.at-rule.document.css', 'punctuation.separator.list.comma.css']
          expect(lines[3][1]).toEqual value: 'regexp', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'support.function.document-rule.css']
          expect(lines[3][2]).toEqual value: '(', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.begin.bracket.round.css']
          expect(lines[3][3]).toEqual value: '"', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'string.quoted.double.css', 'punctuation.definition.string.begin.css']
          expect(lines[3][4]).toEqual value: 'https:.*', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'string.quoted.double.css']
          expect(lines[3][5]).toEqual value: '"', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'string.quoted.double.css', 'punctuation.definition.string.end.css']
          expect(lines[3][6]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.document.css', 'meta.function.document-rule.css', 'punctuation.section.function.end.bracket.round.css']
          expect(lines[3][8]).toEqual value: '{', scopes: ['source.css', 'meta.at-rule.document.css', 'punctuation.section.property-list.begin.css']
      ...
      describe '@viewport', ->
        it 'tokenises @viewport blocks correctly', ->
          ...
          expect(tokens[8]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          expect(tokens[15]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
    ...
    describe 'capitalisation', ->
      ...
      it 'ignores case in unit names', ->
        ...
        expect(lines[0][6]).toEqual value: 'EM', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
        expect(lines[1][6]).toEqual value: 'ReM', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.rem-unit.css']
        ...
        expect(lines[2][6]).toEqual value: 'tURN', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.turn-unit.css']
        expect(lines[3][6]).toEqual value: 'S', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.s-unit.css']
        expect(lines[4][5]).toEqual value: '20', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css']
        expect(lines[4][6]).toEqual value: 'CM', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.cm-unit.css']
        expect(lines[5][6]).toEqual value: 'gRAd', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.grad-unit.css']
  ...
  describe 'property lists (declaration blocks)', ->
    ...
    describe 'values', ->
      ...
      it 'tokenises numeric values correctly', ->
        ...
        expect(lines[0][9]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
        ...
        expect(lines[1][9]).toEqual value: 'ex', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.ex-unit.css']
        ...
        expect(lines[2][9]).toEqual value: 'ch', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.ch-unit.css']
        expect(lines[3][8]).toEqual value: '0.0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css']
        expect(lines[3][9]).toEqual value: 'REM', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.rem-unit.css']
        expect(lines[4][8]).toEqual value: '+0.0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css']
        expect(lines[4][9]).toEqual value: 'vh', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.vh-unit.css']
        expect(lines[5][8]).toEqual value: '-0.0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css']
        expect(lines[5][9]).toEqual value: 'vw', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.vw-unit.css']
        expect(lines[6][8]).toEqual value: '.6', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css']
        expect(lines[6][9]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
        ...
        expect(lines[7][9]).toEqual value: 'mm', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.mm-unit.css']
        ...
        expect(lines[8][9]).toEqual value: 'cm', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.cm-unit.css']
        ...
        expect(lines[9][9]).toEqual value: 'In', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.in-unit.css']
        ...
        expect(lines[10][9]).toEqual value: 'ch', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.ch-unit.css']
      ...
      describe 'functional notation', ->
        describe 'attr()', ->
          it 'tokenises parameters correctly and case-insensitively', ->
            ...
            expect(tokens[13]).toEqual value: '}', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']
        ...
        describe 'calc()', ->
          it 'tokenises calculations', ->
            ...
            expect(lines[1][7]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(lines[1][12]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            ...
            expect(lines[2][12]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            expect(lines[3][7]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(lines[4][7]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
          ...
          it 'requires whitespace around + and - operators', ->
            ...
            expect(tokens[9]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[12]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
          ...
          it 'allows whitespace around * and / operators', ->
          ...
          it 'matches variable expansions inside calculations', ->
            ...
            expect(tokens[18]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.calc.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[22]).toEqual value: '}', scopes: ['source.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']

        describe 'colours', ->
          it 'tokenises colour functions correctly', ->
            {tokens} = grammar.tokenizeLine('a{ color: rgb(187,255,221); }')
            expect(tokens[6]).toEqual value: 'rgb', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'support.function.misc.css']
            expect(tokens[7]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[8]).toEqual value: '187', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(tokens[9]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[10]).toEqual value: '255', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(tokens[11]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[12]).toEqual value: '221', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(tokens[13]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.end.bracket.round.css']

            {tokens} = grammar.tokenizeLine('a{ color: RGBa( 100%, 0% ,20.17% ,.5 ); }')
            expect(tokens[6]).toEqual value: 'RGBa', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'support.function.misc.css']
            expect(tokens[7]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[9]).toEqual value: '100', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[10]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[11]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[13]).toEqual value: '0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[14]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[16]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[17]).toEqual value: '20.17', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[18]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[20]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[21]).toEqual value: '.5', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[23]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.end.bracket.round.css']

            {tokens} = grammar.tokenizeLine('a{color:HSL(0,  00100%,50%)}')
            expect(tokens[4]).toEqual value: 'HSL', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'support.function.misc.css']
            expect(tokens[5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[6]).toEqual value: '0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css']
            expect(tokens[7]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[9]).toEqual value: '00100', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css']
            expect(tokens[10]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[11]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[12]).toEqual value: '50', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css']
            expect(tokens[13]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[14]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.end.bracket.round.css']

            {tokens} = grammar.tokenizeLine('a{color:HSLa(2,.0%,1%,.7)}')
            expect(tokens[4]).toEqual value: 'HSLa', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'support.function.misc.css']
            expect(tokens[5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[6]).toEqual value: '2', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css']
            expect(tokens[7]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[8]).toEqual value: '.0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css']
            expect(tokens[9]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[10]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[11]).toEqual value: '1', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css']
            expect(tokens[12]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(tokens[13]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[14]).toEqual value: '.7', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'constant.numeric.css']
            expect(tokens[15]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.hsla-value.css', 'punctuation.section.function.end.bracket.round.css']

          it 'matches variables as colour components', ->
            {tokens} = grammar.tokenizeLine('a{ color: RGBA(var(--red), 0% , 20%, .2)}')
            expect(tokens[7]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[8]).toEqual value: 'var', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'support.function.misc.css']
            expect(tokens[9]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[10]).toEqual value: '--red', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'variable.argument.css']
            expect(tokens[11]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.end.bracket.round.css']
            expect(tokens[12]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']

          it 'matches comments between colour components', ->
            {tokens} = grammar.tokenizeLine('a{ color: rgba(/**/255/*=*/,0,/*2.2%*/51/*,*/0.2)}')
            expect(tokens[8]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(tokens[9]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(tokens[11]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(tokens[12]).toEqual value: '=', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(tokens[13]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(tokens[14]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[16]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[17]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(tokens[19]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(tokens[21]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(tokens[22]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(tokens[23]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
          ...
          it 'allows colour components to be split across lines', ->
            ...
            """
            expect(lines[1][4]).toEqual value: 'rgba', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'support.function.misc.css']
            expect(lines[1][5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[2][1]).toEqual value: 'var', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'support.function.misc.css']
            expect(lines[2][2]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[2][3]).toEqual value: '--red', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'variable.argument.css']
            expect(lines[2][4]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.end.bracket.round.css']
            expect(lines[2][8]).toEqual value: ' Red ', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[3][1]).toEqual value: 'var', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'support.function.misc.css']
            expect(lines[3][3]).toEqual value: '--green', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'variable.argument.css']
            expect(lines[3][5]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(lines[3][8]).toEqual value: ' Green ', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[4][1]).toEqual value: 'var', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'support.function.misc.css']
            expect(lines[4][2]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[4][3]).toEqual value: '--blue', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'variable.argument.css']
            expect(lines[4][4]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.end.bracket.round.css']
            expect(lines[4][5]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(lines[4][8]).toEqual value: ' Blue ', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[4][9]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(lines[5][1]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(lines[5][2]).toEqual value: ' var(--test),', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[6][0]).toEqual value: '    /*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[6][1]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(lines[6][2]).toEqual value: 'var', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'support.function.misc.css']
            expect(lines[6][3]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[6][4]).toEqual value: '--opacity', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'variable.argument.css']
            expect(lines[6][5]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'meta.function.variable.css', 'punctuation.section.function.end.bracket.round.css']
            expect(lines[6][7]).toEqual value: '/*', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
            expect(lines[6][8]).toEqual value: ' Transparency ', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css']
            expect(lines[6][9]).toEqual value: '*/', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
            expect(lines[7][1]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.end.bracket.round.css']
        ...
        describe 'gradients', ->
          it 'tokenises linear gradients', ->
            ...
            expect(tokens[10]).toEqual value: 'deg', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.deg-unit.css']
          ...
          it 'tokenises radial gradients', ->
            ...
            expect(tokens[13]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[16]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[9]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[14]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(tokens[33]).toEqual value: 'rgba', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'support.function.misc.css']
            expect(tokens[34]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(tokens[35]).toEqual value: '0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[36]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'punctuation.separator.list.comma.css']
            expect(tokens[41]).toEqual value: '.3', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(tokens[42]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.end.bracket.round.css']
          ...
          it 'matches gradients that span multiple lines with injected comments', ->
            ...
            expect(lines[2][12]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
            ...
            expect(lines[3][9]).toEqual value: 'rgba', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'support.function.misc.css']
            expect(lines[3][10]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[3][20]).toEqual value: '0.4', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'constant.numeric.css']
            expect(lines[3][21]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.rgba-value.css', 'punctuation.section.function.end.bracket.round.css']
          ...
          it 'highlights vendored gradient functions', ->
            ...
            expect(lines[1][13]).toEqual value: 'hsl', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'support.function.misc.css']
            expect(lines[1][22]).toEqual value: '70', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css']
            expect(lines[1][23]).toEqual value: '%', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'constant.numeric.css', 'keyword.other.unit.percentage.css']
            expect(lines[1][24]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.end.bracket.round.css']
            ...
            expect(lines[2][13]).toEqual value: 'hsl', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'support.function.misc.css']
            expect(lines[2][14]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[2][24]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.end.bracket.round.css']
            ...
            expect(lines[3][13]).toEqual value: 'hsl', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'support.function.misc.css']
            expect(lines[3][14]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.css', 'meta.function.color.hsl-value.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          it 'highlights antique Webkit syntax as deprecated', ->
            ...
            expect(lines[2][4]).toEqual value: 'rgb', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'support.function.misc.css']
            expect(lines[2][5]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[2][9]).toEqual value: '171', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(lines[2][10]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.separator.list.comma.css']
            ...
            expect(lines[4][6]).toEqual value: 'rgb', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'support.function.misc.css']
            expect(lines[4][7]).toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.begin.bracket.round.css']
            expect(lines[4][8]).toEqual value: '102', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(lines[4][9]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.separator.list.comma.css']
            expect(lines[4][11]).toEqual value: '204', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(lines[4][12]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.separator.list.comma.css']
            expect(lines[4][14]).toEqual value: '0', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'constant.numeric.css']
            expect(lines[4][15]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.end.bracket.round.css']
            ...
            expect(lines[5][12]).toEqual value: ')', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgb-value.css', 'punctuation.section.function.end.bracket.round.css']
            ...
            expect(lines[6][31]).toEqual value: 'rgba', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.gradient.invalid.deprecated.gradient.css', 'meta.function.color.rgba-value.css', 'support.function.misc.css']
        ...
        describe 'other functions', ->
          it 'tokenises basic-shape functions', ->
            ...
            expect(lines[1][7]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.shape.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            ...
            expect(lines[2][7]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.shape.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            ...
            expect(lines[2][11]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.shape.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            ...
            expect(lines[2][15]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.shape.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
            ...
            expect(lines[2][19]).toEqual value: 'em', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.shape.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
          ...
          it 'tokenises image-set()', ->
            ...
            expect(lines[1][11]).toEqual value: '1', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'constant.numeric.css']
            expect(lines[1][12]).toEqual value: 'x', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'variable.parameter.misc.css']
            expect(lines[1][13]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'punctuation.separator.list.comma.css']
            ...
            expect(lines[2][5]).toEqual value: '2', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'constant.numeric.css']
            expect(lines[2][6]).toEqual value: 'x', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'variable.parameter.misc.css']
            expect(lines[2][7]).toEqual value: ',', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'punctuation.separator.list.comma.css']
            ...
            expect(lines[3][6]).toEqual value: 'dpi', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'meta.function.misc.css', 'constant.numeric.css', 'keyword.other.unit.dpi-unit.css']
        ...
        it 'does not tokenise functions with whitespace between name and parameters', ->
          ...
          expect(tokens[8]).not.toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(tokens[4]).not.toEqual value: 'url', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'support.function.url.css']
          expect(tokens[6]).not.toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'punctuation.section.function.begin.bracket.round.css']
          ...
          expect(tokens[7]).not.toEqual value: '(', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'punctuation.section.function.begin.bracket.round.css']
  ...
  describe 'comments', ->
    ...
    it 'tokenizes comments inside query lists', ->
      ...
      expect(tokens[8]).toEqual value: 'em', scopes: ['source.css', 'meta.at-rule.media.css', 'constant.numeric.css', 'keyword.other.unit.em-unit.css']
      expect(tokens[9]).toEqual value: '/*', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.begin.css']
      expect(tokens[10]).toEqual value: ' comment ', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css']
      expect(tokens[11]).toEqual value: '*/', scopes: ['source.css', 'meta.at-rule.media.css', 'comment.block.css', 'punctuation.definition.comment.end.css']
      expect(tokens[12]).toEqual value: ')', scopes: ['source.css', 'meta.at-rule.media.css', 'punctuation.definition.parameters.end.bracket.round.css']
    ...
    it 'tokenizes inline comments', ->
      ...
      expect(tokens[6]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
  ...
  describe 'Transforms', ->
    it 'tokenizes transform functions', ->
      ...
      expect(tokens[1][22]).toEqual value: 'px', scopes: ['source.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.numeric.css', 'keyword.other.unit.px-unit.css']
  ...
  describe 'nested selectors', ->
    ...
    describe 'properties in nested rulesets', ->
      it 'tokenises properties in nested rulesets', ->
        ...
        expect(lines[1][6]).toEqual value: 'content', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-name.css', 'support.type.property-name.css']
        expect(lines[1][7]).toEqual value: ':', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.separator.key-value.css']
        expect(lines[1][9]).toEqual value: '&', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-value.css']
        expect(lines[1][10]).toEqual value: ';', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.terminator.rule.css']
        expect(lines[2][6]).toEqual value: 'content', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-name.css', 'support.type.property-name.css']
        expect(lines[2][9]).toEqual value: '&', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-value.css']
        expect(lines[2][11]).toEqual value: '}', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.section.property-list.end.css']
        ...
        expect(lines[3][4]).toEqual value: '{', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.section.property-list.begin.css']
        expect(lines[4][1]).toEqual value: 'text-decoration', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-name.css', 'support.type.property-name.css']
        expect(lines[4][2]).toEqual value: ':', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.separator.key-value.css']
        expect(lines[4][4]).toEqual value: 'underline', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-value.css', 'support.constant.property-value.css']
        expect(lines[4][5]).toEqual value: ';', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.terminator.rule.css']
        expect(lines[5][1]).toEqual value: '&', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.nested.selector.css', 'keyword.operator.nesting.css']
        expect(lines[5][2]).toEqual value: '.', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.nested.selector.css', 'entity.other.attribute-name.class.css', 'punctuation.definition.entity.css']
        expect(lines[5][3]).toEqual value: 'footer-link', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.nested.selector.css', 'entity.other.attribute-name.class.css']
        expect(lines[6][1]).toEqual value: 'color', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-name.css', 'support.type.property-name.css']
        expect(lines[6][2]).toEqual value: ':', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-list.css', 'punctuation.separator.key-value.css']
        expect(lines[6][4]).toEqual value: '#', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.other.color.rgb-value.hex.css', 'punctuation.definition.constant.css']
        expect(lines[6][5]).toEqual value: 'f00', scopes: ['source.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-list.css', 'meta.property-value.css', 'constant.other.color.rgb-value.hex.css']
